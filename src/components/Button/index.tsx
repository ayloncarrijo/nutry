  ...
  (
    ...
    return (
      <button
        ref={ref}
        type="button"
        tw="inline-flex justify-center items-center rounded-full px-4 py-2 text-white font-medium select-none disabled:(text-gray-300 text-opacity-40 cursor-not-allowed)"
        css={[
          ...
          isLoading && tw`disabled:(text-opacity-0)`,
          {
            ...
            contained: tw`bg-blue-500 not-disabled:(shadow-md) not-disabled:hover:(bg-blue-600) disabled:(bg-gray-600 bg-opacity-25)`,
          }[variant],
        ]}
        disabled={isDisabled}
        {...props}
