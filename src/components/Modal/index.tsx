...
function Modal({ onDismiss, children }: ModalProps): JSX.Element {
  React.useEffect(() => {
    ...
    <div tw="z-50 fixed inset-0">
      ...
      <div tw="absolute inset-0 flex flex-col">
        ...
        <div tw="min-h-0 flex justify-center items-center flex-1 p-2">
          <div tw="overflow-y-auto max-w-2xl max-h-full rounded-xl p-4 bg-gray-800">
            {children}
          </div>
        </div>
      </div>
